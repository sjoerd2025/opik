...
og:description:
  Integrate Opik with your LLM application to log calls and chains efficiently.
...
<Tabs>
  ...
  <Tab title="TypeScript SDK" value="typescript-sdk">
    ...
    <Steps>
      ...
      <Step>
        ...
        On Opik Cloud, the wizard validates your API key and suggests your default workspace automatically.
      </Step>
      <Step>
  ...
  <Tab title="OpenAI (TS)" value="openai-ts-sdk">
    ...
    <Steps>
      <Step>
        Install the OpenAI SDK, the Opik SDK, and the OpenAI integration package:
      ...
      <Step>
        ...
        For a full Node.js and TypeScript walkthrough, see the [OpenAI integration guide](/integrations/openai-typescript).
