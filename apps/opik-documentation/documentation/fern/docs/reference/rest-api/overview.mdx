...
og:description:
  Explore the Opik REST API to integrate seamlessly with Open-Source
...
<Info>
  The Opik REST API is stable but currently in beta and subject to change. If
  you have any questions or feedback about the APIs, please reach out on GitHub:
  https://github.com/comet-ml/opik.
</Info>

The REST reference on this site is generated from Opik's OpenAPI specification.
If you need a machine-readable source, use
[`opik.yaml`](https://raw.githubusercontent.com/comet-ml/opik/refs/heads/main/apps/opik-documentation/documentation/fern/openapi/opik.yaml).
