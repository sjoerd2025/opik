...
- **Insights** — built-in and custom views embedded directly in project pages for quick, in-context monitoring
...
- **Breakdown**: Optionally group data by trace name to see per-workflow patterns
